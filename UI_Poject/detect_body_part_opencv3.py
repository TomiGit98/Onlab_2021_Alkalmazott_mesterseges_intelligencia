...
class Ui_MainWindow(object):
    ...
    def faceDetect(self):
        ...
        self.pixmax_image = QtGui.QPixmap(file_path)
        width = self.pixmax_image.width()
        height = self.pixmax_image.height()
        ...
        temp_w, temp_h = self.resizeImage(self.pixmax_image.width(), self.pixmax_image.height())
        self.pixmax_image = self.pixmax_image.scaled(temp_w.__int__(), temp_h.__int__())

        self.image.setPixmap(self.pixmax_image)
        self.image.setAlignment(Qt.Qt.AlignCenter)
        self.image.show()
